...
const DISHES: Dish[] = [
  ...
  { name: "Tandoori Chicken", flag: "🇮🇳", origin: "India-5", img: u("1565557623262-b51c2513a641")},
  ...
  { name: "Banh Mi", flag: "🇻🇳", origin: "Vietnam-2", img: u("1600891964092-4316c288032e")},
  ...
  { name: "Xiao Long Bao", flag: "🇨🇳", origin: "China-2", img: xiaoLongBaoImg},
  ...
  { name: "Beef Bourguignon", flag: "🇫🇷", origin: "France-4", img: u("1504674900247-0877df9cc836")},
  ...
  { name: "Adana Kebab", flag: "🇹🇷", origin: "Turkey", img: u("1529193591184-b1d58069ecdd")},
  { name: "Turkish Baklava", flag: "🇹🇷", origin: "Turkey-2", img: u("1571877227200-a0d98ea607e9") },
  { name: "Lomo Saltado", flag: "🇵🇪", origin: "Peru", img: lomoSaltadoImg},
  { name: "Ceviche", flag: "🇵🇪", origin: "Peru-2", img: u("1559339352-11d035aa65de") },
  { name: "Feijoada", flag: "🇧🇷", origin: "Brazil", img: u("1604152135912-04a022e23696")},
  ...
  { name: "Chicken Adobo", flag: "🇵🇭", origin: "Philippines", img: u("1606728035253-49e8a3146cfa")},
  { name: "Lechon", flag: "🇵🇭", origin: "Philippines-2", img: u("1432139509613-5c4255815697")},
  ...
  { name: "Sunday Roast", flag: "🇬🇧", origin: "UK-2", img: u("1432139509613-5c4255815697")},
  { name: "Shepherd's Pie", flag: "🇬🇧", origin: "UK-3", img: u("1574484184081-afea8a62f9c4") },
  { name: "Bratwurst Plate", flag: "🇩🇪", origin: "Germany", img: u("1597393353415-b3730f3719fe")},
  { name: "Schnitzel", flag: "🇩🇪", origin: "Germany-2", img: u("1599921841143-819065280333")},
  ...
  { name: "Beef Stroganoff", flag: "🇷🇺", origin: "Russia", img: u("1606755962773-d324e0a13086")},
  { name: "Goulash", flag: "🇭🇺", origin: "Hungary", img: u("1547308283-0b0b4b1c6e5e")},
  { name: "Smørrebrød", flag: "🇩🇰", origin: "Denmark", img: u("1466637574441-749b8f19452f")},
  { name: "Swedish Meatballs", flag: "🇸🇪", origin: "Sweden", img: u("1529042410759-befb1204b468")},
  ...
  { name: "Wiener Schnitzel", flag: "🇦🇹", origin: "Austria", img: u("1619221882220-947b3d3c8861")},
  ...
  { name: "Falafel Wrap", flag: "🇪🇬", origin: "Egypt", img: u("1547928576-b822bc410bdf")},
  { name: "Koshari", flag: "🇪🇬", origin: "Egypt-2", img: u("1601050690597-df0568f70950")},
  { name: "Bunny Chow", flag: "🇿🇦", origin: "South Africa", img: bunnyChowImg},
  { name: "Bobotie", flag: "🇿🇦", origin: "South Africa-2", img: u("1574484184081-afea8a62f9c4")},
  { name: "Jerk Chicken", flag: "🇯🇲", origin: "Jamaica", img: u("1598103442097-8b74394b95c6")},
  { name: "Cuban Sandwich", flag: "🇨🇺", origin: "Cuba", img: u("1528207776546-365bb710ee93") },
  { name: "Arepas", flag: "🇻🇪", origin: "Venezuela", img: u("1626200926749-2474a5b5e7d0")},
  { name: "Ajiaco", flag: "🇨🇴", origin: "Colombia", img: u("1547308283-0b0b4b1c6e5e")},
  ...
  { name: "Açaí Smoothie Bowl", flag: "🍓", origin: "Brunch-3", img: u("1502741224143-90386d7f8c82")},
  ...
  { name: "Burrata Caprese", flag: "🥗", origin: "Salad-2", img: u("1551782450-a2132b4ba21d")},
  ...
  { name: "Cheesecake Slice", flag: "🍰", origin: "Dessert-6", img: u("1567171466295-4afa63d45416")},
