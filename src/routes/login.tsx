      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white border-4 border-border rounded-[32px] p-6 shadow-[8px_8px_0px_0px_var(--border)]">
          ...
          <button
            ...
            onClick={onApple}
            disabled={loading}
            className="mt-2 w-full bg-black text-white border-2 border-border py-2.5 rounded-2xl font-black text-sm uppercase shadow-[0px_4px_0px_0px_var(--border)] active:shadow-[0px_1px_0px_0px_var(--border)] active:translate-y-1 transition-all disabled:opacity-60 flex items-center justify-center gap-2"
          >
          ...
          <p className="mt-3 text-[10px] text-center text-muted-foreground leading-relaxed">
            Microsoft, X and other providers aren't supported by our auth yet — use email, Google or Apple.
          </p>
          </>
          )}
        </div>
